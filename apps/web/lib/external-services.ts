...
// All twelve services (wokwi, codesandbox, makecode, geogebra, phet, desmos,
// blockly_games, visualgo, p5js, excalidraw, learningapps, sqlonline) support
// iframe embed.
...
export function isExternalService(ct: string | null | undefined): ct is ExternalServiceType {
  return (
    ct === "wokwi" || ct === "codesandbox" || ct === "makecode" ||
