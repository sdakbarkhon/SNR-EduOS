...
export function BottomBar({ locale }: { locale: Locale }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-30 flex items-center justify-between gap-3 px-6">
      ...
      <p className="pointer-events-auto rounded-full border border-white/60 bg-white/50 px-4 py-2 text-center text-sm font-medium text-slate-700 backdrop-blur-xl">
