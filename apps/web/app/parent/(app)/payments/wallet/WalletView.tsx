 ...
 * ребёнка, четыре быстрых действия, итоги периода, последние операции.
 * Действия ведут на соседние экраны — пополнение, перевод, лимиты, все
 * операции; ни одно из них ничего не списывает.
 */
...
/**
 * Быстрые действия под балансом — те же, что в мобильном экране.
 *
 * Их два, а не четыре: «Перевести» и «Лимиты» заказчик снял 27.08.2026
 * насовсем. Сетка тоже на две колонки, а не на четыре с двумя дырами —
 * пустая ячейка читается как «кнопка не загрузилась».
 */
const ACTIONS = [
