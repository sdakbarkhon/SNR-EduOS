...
/** Error-граница маршрута /parent/homework — общий компонент ../_study/StudyError.
 *  parent-queries не глотает ошибки, поэтому сбой должен быть видим и
 *  повторяем, а не выглядеть как «данных нет». */
export default function HomeworkError(props: { error: Error & { digest?: string }; reset: () => void }) {
