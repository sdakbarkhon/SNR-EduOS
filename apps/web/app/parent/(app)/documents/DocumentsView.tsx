...
function buildChildDocs(childName: string, className: string): DocItem[] {
  ...
  return [
    ...
    {
      id: "passport",
      name: "Паспорт ученика",
      meta: `${owner} · PDF · 980 КБ`,
      dateLabel: "Добавлен 12 января 2026",
    ...
    },
    {
      ...
      meta: `${owner} · PDF · 2,4 МБ`,
      dateLabel: "Обновлена 14 марта 2026",
    ...
    },
    {
      ...
      meta: `${owner} · PDF · 610 КБ`,
      dateLabel: "Действует до 31 августа 2026",
...
function buildParentDocs(parentName: string): DocItem[] {
  ...
  return [
    ...
    },
    {
      ...
      meta: `${owner} · PDF · 1,1 МБ`,
      dateLabel: "Добавлен 3 сентября 2025",
      gradient: ["#fbbf24", "#b45309"],
      paths: ICON.doc,
    },
    {
      id: "contract",
      name: "Договор со школой",
      meta: `${owner} · PDF · 780 КБ`,
      dateLabel: "Подписан 1 сентября 2025",
      gradient: ["#2dd4bf", "#0f766e"],
      paths: ICON.checkSquare,
    },
    {
      id: "travel-permission",
      name: "Разрешение на выезд",
      meta: `${owner} · PDF · 450 КБ`,
      dateLabel: "Действует до 31 мая 2027",
      gradient: ["#38bdf8", "#0369a1"],
      paths: ICON.globe,
    },
    {
      id: "media-permission",
      name: "Разрешение на съёмку и публикацию",
      meta: `${owner} · PDF · 320 КБ`,
      dateLabel: "Подписано 1 сентября 2025",
