...
export const SEARCH_RESULTS: SearchResultRow[] = [
  ...
  { filter: "msgs", header: "СООБЩЕНИЯ", name: "Дилдора Касымова", subtitle: "Классный руководитель 3-А", detail_label: "чат", go: "d25" },
  ...
  { filter: "pays", header: "ОПЛАТЫ", name: "Чек № RCP-2026-07-018", subtitle: "Обучение · июль · 4 500 000 сум", detail_label: "чек", go: "d21" },
