  ...
  async function handleCreateOne(t: CurriculumTopicWithUsage) {
    ...
    try {
      await createLesson(db, {
        ...
        // Длительность не передаём: с 01.09.2026 (миграция 246) её задаёт
        // школа одним числом, а createLesson читает его сам. Здесь стояло
        // жёсткое 45 — четвёртый источник того же числа.
