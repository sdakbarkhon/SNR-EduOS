...
/**
 * Monaco editor embedded directly in the stage card (no modal). The parent
 * card already renders stage.title/description, so this only shows what's
 * specific to the code task: language, grade, editor, run, output, submit.
 */
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {!readOnly && (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-6 py-2.5 text-sm font-bold text-white shadow-md shadow-violet-500/25 transition-all hover:from-violet-700 hover:to-purple-700 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
          >
