...
export default async function LessonPage({
  ...
  // schools.is_demo — урок в демо-школе. Решает контролы у видео, которое
  // показывает учитель, «Управление этапами», и с 11.09.2026 — листание
  // презентации у себя и выход из неё. Хелпер глотает ошибку и отдаёт false:
  // при сбое применяются правила реальной школы, в том числе замок презентации.
