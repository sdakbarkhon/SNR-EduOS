...
import {
  LayoutDashboard, School, UserCog, Settings,
    ...
    >
      ...
      {!isCollapsed && (
        <div className="mb-8 px-3">
          <div className="w-fit rounded-xl bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-sm">
            {dsa.role}
          </div>
        </div>
      )}
