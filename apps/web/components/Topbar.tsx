...
export function Topbar({
  ...
  return (
    // mx-auto max-w-[1920px] — карточка-шапка выравнивается по той же
    // ширине/центру, что и <main> ниже в AppShell.tsx (финальная целевая
    // ширина по решению пользователя, было 1600).
    <header className="mx-auto flex w-full max-w-[1920px] shrink-0 items-center justify-between gap-4 rounded-[20px] bg-white py-3 pl-6 pr-4 shadow-[0_8px_22px_rgba(93,80,150,0.05)]">
