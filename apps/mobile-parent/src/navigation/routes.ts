...
export const STUBS: Record<string, StubInfo> = {
  ...
  // Заход 5 (заглушки): кнопка-фильтр в «Всех предметах» была задокументированным
  // no-op. Своей записи в макете у неё нет — заводим здесь, чтобы нажатие вело
  // на честное объяснение, а не молчало.
  subjfilter: { t: "Фильтр предметов", n: "Действие", g: ["#38bdf8", "#0284c7"], i: "grid" },
};
