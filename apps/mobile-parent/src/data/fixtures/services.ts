...
export const PORTFOLIO_WORKS: PortfolioWorkRow[] = [
  { subject_id: "prog", name: "Проект «Калькулятор»", date: "2026-07-22", grade: 5 },
  { subject_id: "robo", name: "Манипулятор: сборка", date: "2026-07-18", grade: 4 },
  { subject_id: "math", name: "Проценты в жизни", date: "2026-07-12", grade: 5 },
  { subject_id: "eng", name: "Постер «My Summer»", date: "2026-07-08", grade: 4 },
];

export const PORTFOLIO_ACHIEVEMENTS: AchievementRow[] = [
  { name: "Победитель олимпиады по математике", subtitle: "Городской этап · 1 место", month: "2026-05", gradient: ["#facc15", "#ca8a04"] },
  { name: "Лучший проект четверти", subtitle: "Программирование · «Калькулятор»", month: "2026-07", gradient: ["#38bdf8", "#0284c7"] },
  { name: "100% посещаемость", subtitle: "Июнь без единого пропуска", month: "2026-06", gradient: ["#34d399", "#059669"] },
  { name: "Активный участник дебатов", subtitle: "Школьный клуб дебатов", month: "2026-04", gradient: ["#f472b6", "#db2777"] },
];

export const PORTFOLIO_CERTIFICATES: CertificateRow[] = [
  { name: "Диплом олимпиады по математике", org: "Управление образования г. Ташкента", month: "2026-05" },
  { name: "Сертификат «Python Basics»", org: "SNR IT Lab", month: "2026-07" },
  { name: "Сертификат English A2", org: "Экзаменационный центр", month: "2026-03" },
  { name: "Сертификат «Робототехника: старт»", org: "SNR International School", month: "2026-02" },
];
...
export const WORK_DETAILS: WorkDetailRow[] = [
  ...
  },
  {
    ...
    comment:
      "Взяты живые примеры, в расчётах ошибок нет. Одна из лучших работ в классе — рекомендую на школьную конференцию.",
...
export const APPLICATIONS: ApplicationRow[] = [
  { status: "rev", name: "Справка для спортивной секции", number_label: "№ 2026-07-016", date: "2026-07-21", gradient: ["#38bdf8", "#0284c7"] },
  { status: "ok", name: "Справка об обучении", number_label: "№ 2026-07-014", date: "2026-07-18", ready_from: "2026-07-24", gradient: ["#34d399", "#059669"] },
  { status: "rev", name: "Отсутствие по семейным обстоятельствам", number_label: "№ 2026-07-011", date: "2026-07-15", gradient: ["#fbbf24", "#f97316"] },
  { status: "no", name: "Перевод в другой класс", number_label: "№ 2026-06-021", date: "2026-06-28", gradient: ["#a78bfa", "#7c3aed"] },
  { status: "ok", name: "Академический отпуск (лето)", number_label: "№ 2026-06-015", date: "2026-06-20", ready_from: "2026-07-01", gradient: ["#f472b6", "#db2777"] },
];
...
export const VACCINATIONS: VaccinationRow[] = [
  { name: "АКДС (ревакцинация)", date: "2015-03-12", status: "ok" },
  { name: "Корь · краснуха · паротит", date: "2016-06-05", status: "ok" },
  { name: "Гепатит B (курс)", date: "2011-01-14", status: "ok" },
  { name: "Грипп (сезонная)", date: "2025-10-10", status: "ok" },
  { name: "АДС-М (ревакцинация)", month: "2026-09", status: "plan" },
];
