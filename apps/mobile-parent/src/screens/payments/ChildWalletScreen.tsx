    ...
    <AppBackground>
      ...
      >
        ...
        {/* BLOCK 3 — Quick Actions Grid.
            ...
            28.08.2026: ОСТАЛЬНУЮ витрину раздела оплат вернули (карты,
            автоплатёж, чеки — см. раздел 0 в CLAUDE_CHAT_HANDOFF.md). Эти
            два действия не вернулись и не вернутся. Кнопки растянуты на
            половину ширины каждая: четыре ячейки с двумя пустыми читаются
            как «кнопка не загрузилась». */}
