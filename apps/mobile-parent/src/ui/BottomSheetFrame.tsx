 ...
 * переиспользует) рендерились ПОВЕРХ `FloatingTabBar` — он живёт в
 * основном дереве React-Native и не имеет общего zIndex с потомками
 * экранов. RN Modal открывает отдельное нативное окно поверх всего
 * RN-контента и одновременно закрывает back-жест на Android. Своя
