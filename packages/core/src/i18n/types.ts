...
export interface Dictionary {
  ...
  teacher: {
    ...
    hwServicesNeedSubject: string;
    hwClassAndSubject: string;
    hwAiNeedsClassSubject: string;
    hwAiFilledTitle: string;
    hwAiFilledBody: string;
    hwAiFilledHint: string;
    hwAiReplace: string;
    hwAiAppend: string;
    hwAiFieldQuestions: string;
    hwAiFieldCode: string;
    hwAiFieldTemplate: string;
    hwAiFieldSubtasks: string;
    hwErrTitle: string;
    hwErrTask: string;
